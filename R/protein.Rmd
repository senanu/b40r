...
I strongly recommend that you read this file using the "Visual" rather than "Source" mode. However, if you need to send me (if you get stuck), you'll need to switch back to "Source" before copy-and-pasteing.
